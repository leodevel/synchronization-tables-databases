...
import br.com.marino.monitorar.modules.DataSynchronizeModule;
import br.com.marino.monitorar.services.DataSynchronizeService;
...
public class JPDataSynchronize extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/marino/monitorar/images/cancel.png"))); // NOI18N
        ...
        if (btIniciar.getText().equals("Iniciar")) {
            ...
            try {
                ...
                lbIcon.setIcon(new javax.swing.ImageIcon(getClass().
                        getResource("/br/com/marino/monitorar/images/start.png")));
            ...
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass()
                    .getResource("/br/com/marino/monitorar/images/cancel.png")));
